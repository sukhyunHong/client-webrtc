...
const selectInitLoading = createSelector([selectRaw], user => user.initLoading)

const selectDataLoading = createSelector([selectRaw], user => user.dataLoading)

const selectSaveLoading = createSelector([selectRaw], user => user.saveLoading)
...
const selectFindLoading = createSelector([selectRaw], user => user.findLoading)
