    ...
    const modal = (
        <WrapperAlert>
            <div className="container-alert">
                <i className="material-icons clear-icon" onClick={(e) => closeEvent(e)}>clear</i>
                ...
                <div className="container-alert__btn">
                    <button className="container-alert__btn--cancel" onClick={() => { handleClickReject(); closeEvent()}}>취소</button>
                    <button className="container-alert__btn--accept" onClick={() => { handleClickAccept(); closeEvent()}}>종료하기</button>
                </div>
            </div>
        </WrapperAlert>
    )
